...
int main(void)
{
  ...
  DMA_InitStructure.DMA_MemoryInc = ((uint32_t)0x00000000);
 ...
 while(1)
  {
   ...
   if (ticks++ >= 900000) {                   
    ...
    if (Clock1s) {
	  ...
	  AD_value=ADC_GetConversionValue(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)));
	  ...
	  AD1_value=ADC_GetConversionValue(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)));
...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000200) | ((uint32_t)0x00000010), ENABLE);
